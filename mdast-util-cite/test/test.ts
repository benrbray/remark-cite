...
describe('mdast-util-wiki-link', () => {
	...
	runTestSuite("fromMarkdown :: test cases with a single citation node", "single-test", singleTestCases);
	runTestSuite("fromMarkdown :: test cases with a multiple citation nodes", "multi-test", multiTestCases);
